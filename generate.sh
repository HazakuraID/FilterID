...
# Jika rilis Bromite resmi terbaru berisi alat rulesset_converter, kami mengambilnya dari sana.
# Jika tidak, kami hanya mengunduh dari build lain dan mengekstraknya dari sana
...
# Jika file daftar default ada, kami menimpanya dengan yang sebenarnya official list
...
# Sekarang semuanya sudah diatur, kita dapat mulai benar-benar menghasilkan filter list
./filtrite 
